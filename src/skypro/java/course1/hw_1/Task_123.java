...
public class Task_123 {
    public static void main(String[] args) {
        ...
        System.out.println("\nЗадание 2.");
        String upperFullName = fullName.toUpperCase();  // верхний регистр записываем в новую переменную
        System.out.println("Данные ФИО сотрудника для заполнения отчета — " + upperFullName);

        /* Задание 3. Система, в которой мы работаем, не принимает символ “ё”. Поэтому нам нужно написать программу,
        которая заменяет символ “ё” на символ “е”. В качестве исходных данных используйте строку fullName и данные в ней
        “Иванов Семён Семёнович”. Выведите результат программы в консоль в формате: ”Данные ФИО сотрудника — ...” */
        System.out.println("\nЗадание 3.");
